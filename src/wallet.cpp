...
// DigitalRupee: total coins staked (non-spendable until maturity)
...
// DigitalRupee: get current stake weight
...
// DigitalRupee: check 'spent' consistency between wallet and txindex
// DigitalRupee: fix wallet spent state according to txindex
...
// DigitalRupee: disable transaction (only for coinstake)
